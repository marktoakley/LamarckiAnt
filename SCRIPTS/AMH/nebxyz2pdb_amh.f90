      ...
      DOUBLE PRECISION :: STRUCT(MAXATOMS),DDUMMY
...
!     This program converts neb.xyz files into a set of pdb files
...
!     2.  The path to the neb.xyz is set to the local directory.
...
25      FORMAT(25(I2,1X))
      CLOSE(1)
       ...
       CALL SYSTEM('cat neb.xyz | grep  "Ener" | wc -l > temptemp') 
...
! 2.  path to the path.xys is set to the local directory
      ...
      OPEN (UNIT=99,FILE='neb.xyz',STATUS='OLD')
      DO J3=1,NFRAMES
       READ(99,*)
       READ(99,*) 
        GLYC=0
...
!         The C-prime and N postions don't depend on C-beta positions
          READ(99,*)DUMMY,DDUMMY,DDUMMY,DDUMMY
