      SUBROUTINE DIPOLARMORSE (X, G, ENERGY, GTEST)

      USE COMMONS, ONLY: NATOMS, STOCKMU, EFIELDT, EFIELD, RHO

      IMPLICIT NONE

      INTEGER          :: I, J, J1, J2, J3, J4, J5, J6, J7, J8, REALNATOMS, OFFSET 
      DOUBLE PRECISION :: X(3*NATOMS), G(3*NATOMS)
      DOUBLE PRECISION :: ENERGY, R2, R4, R6, R12, ABSRIJ, RIJSQ, DPFCT, DVDR, FCTR
      ...
      CALL DEFDIPOLARMORSE(STOCKMU, DU, DPFCT)
...
!     DIPOLAR CONTRIBUTION
      ...
      END SUBROUTINE DIPOLARMORSE
 
!     ----------------------------------------------------------------------------------------------

      SUBROUTINE DEFDIPOLARMORSE(STOCKMU, DU, DPFCT)
      ...
      END SUBROUTINE DEFDIPOLARMORSE
