      SUBROUTINE WATERPDC (X, G, ENERGY, GTEST)
      ...
      CALL DEFWATERPDC(CHARGE, C6, C12, CC, POLAR)
...
!     DERIVATIVES OF THE T MATRIX
      ...
      END SUBROUTINE WATERPDC  

!     ----------------------------------------------------------------------------------------------

      SUBROUTINE DEFWATERPDC (CHARGE, C6, C12, CC, POLAR)
